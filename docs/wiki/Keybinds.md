...
|-----|--------|-------------|
| `R` | Toggle Reach | Extend interaction range |
| `G` | Toggle Fly | Survival flight |
| `X` | Toggle ESP | Entity highlighting and tracers |
| `V` | Toggle Auto Hit | Auto-attack nearest entity |
| `B` | Toggle Low HP Kill | Target low-health entities |
| `K` | Toggle Auto Kill When Low | Attack when your HP is low |
| `N` | Toggle Eating Assist | Auto-eat food when hungry |
| `U` | Toggle Jesus | Walk on water/lava |
...
| `Right Shift` | Open Config | Full settings GUI |
