...
public class WalkToCoordsHandler {
    ...
    public static void tick(Minecraft client) {
        ...
        boolean solidAboveHead = isSolid(client.level.getBlockState(headAhead.up()));
        boolean clearAboveFeet = !isSolid(client.level.getBlockState(feetAhead.up()))
                && !isSolid(client.level.getBlockState(feetAhead.up().up()));
        ...
        boolean gapAhead = !isSolid(client.level.getBlockState(groundAhead))
                && !isSolid(client.level.getBlockState(groundAhead.down()))
        ...
        if (shouldJump) {
            KeyMapping.set(client.options.keyJump.getDefaultKey(), true);
