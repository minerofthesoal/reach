...
title @s actionbar [{"text":"[OSP] ","color":"gold"},{"text":"Reach distance: ","color":"gray"},{"score":{"name":"@s","objective":"osp.reach_dist"},"color":"aqua"},{"text":"/10 blocks","color":"gray"}]
...
scoreboard players set @s osp.reach_dist 0
