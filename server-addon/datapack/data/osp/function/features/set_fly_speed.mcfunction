...
title @s actionbar [{"text":"[OSP] ","color":"gold"},{"text":"Fly speed: ","color":"gray"},{"score":{"name":"@s","objective":"osp.fly_speed"},"color":"light_purple"},{"text":"/10x","color":"gray"}]
...
scoreboard players set @s osp.fly_speed 0
