...
title @s actionbar [{"text":"[OSP] ","color":"gold"},{"text":"Speed multiplier: ","color":"gray"},{"score":{"name":"@s","objective":"osp.speed_mult"},"color":"green"},{"text":"/10x","color":"gray"}]
...
scoreboard players set @s osp.speed_mult 0
