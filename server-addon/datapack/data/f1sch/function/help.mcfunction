...
tellraw @s [{"text":"  /trigger f1sch.give set <code>","color":"yellow","clickEvent":{"action":"suggest_command","value":"/trigger f1sch.give set 1"}},{"text":" - Give item by code","color":"gray"}]
...
tellraw @s [{"text":"  /trigger f1sch.op set 1","color":"yellow","clickEvent":{"action":"suggest_command","value":"/trigger f1sch.op set 1"}},{"text":" - Request OP (requires server addon mod)","color":"gray"}]
